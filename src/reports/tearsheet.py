...
def main():
    ...
    print()
    print("DAY 34 COMPANY TEARSHEET BATCH")
    print("=" * 50)
    print()
    print(
        f"Target companies: {len(companies)}"
    )
    print()
    ...
    print()
    print("=" * 50)
    print("DAY 34 COMPANY TEARSHEET BATCH COMPLETE")
    print("=" * 50)
    print(
        f"Target companies: {len(companies)}"
    )
    ...
    print(
        f"Skipped/failed: {len(skipped)}"
    )
    print(
        f"Output directory: {output_dir}"
    )
    print(
        f"Skip log: {skipped_path}"
    )
